# -*- coding: utf-8 -*-
"""
Created on Mon Feb 11 17:12:54 2019
...
def change_rain(rain,infile,outfile):
    temfile=outfile#infile+'tem_rain.inp'
...
if __name__ == '__main__':
    ...
    for i in range(10):
        infile='./NN_mf/ot.inp'
        outfile='./test SWMM/ot'+str(i)+'.inp'
        A=random.randint(5,15)
        C=random.randint(5,20)
        P=random.randint(1,5)
        b=1#random.randint(1,3)
        n=0.5#random.random()
        R=i/10#random.random()
        deltt=1
        t=240
        ...
        change_rain(rain,infile,outfile)